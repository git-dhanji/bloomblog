      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            {<Logo width="200px" LogoName="Bloomblog"/>}
            </Link>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <Link to="h/" className="hover:underline">BloomBlog</Link>
                </li>
                <li>
                  <Link to="https://webdhan.vercel.app/" className="hover:underline">Portfolio:</Link>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <Link to="https://github.com/pankaj-coder47" className="hover:underline ">Github</Link>
                </li>
                <li>
